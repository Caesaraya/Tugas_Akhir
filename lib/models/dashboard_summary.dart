class DashboardSummary {
  ...
  factory DashboardSummary.fromJson(Map<String, dynamic> json) {
    return DashboardSummary(
      ...
      persentasePerubahan:
          double.tryParse(json['persentase_perubahan'].toString()) ?? 0.0,
      profitBulanIni:
          double.tryParse(json['profit_bulan_ini'].toString()) ?? 0.0,
      totalTransaksiBulanIni:
          int.tryParse(json['total_transaksi_bulan_ini'].toString()) ?? 0,
      jumlahBahanKritis:
          int.tryParse(json['jumlah_bahan_kritis'].toString()) ?? 0,
    );
  }
  ...
  DashboardSummary copyWith({
    ...
    return DashboardSummary(
      ...
      totalTransaksiBulanIni:
          totalTransaksiBulanIni ?? this.totalTransaksiBulanIni,
