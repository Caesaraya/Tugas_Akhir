...
class KelolaProdukController extends GetxController {
  ...
  void showEditForm(BuildContext context, Product product) {
    ...
    priceController.text = currencyFormatter.format(product.price ?? 0);
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildTextField(priceController, "Harga", isNumber: true, isPrice: true),
              const SizedBox(height: 12),
              _buildTextField(discountPercentController, "Diskon (%)", isNumber: true),
              const SizedBox(height: 12),
  ...
  Widget _buildTextField(TextEditingController controller, String label, {bool isNumber = false, bool isPrice = false}) {
  return TextField(
