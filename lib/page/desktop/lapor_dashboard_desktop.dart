...
import 'package:tugas_akhir/widget/widget desktop/lapor/laporan_riwayat_desktop.dart';
    ...
    return Scaffold(
      ...
      body: Row(
        ...
        children: [
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: ClipRRect(
                                ...
                                child: DataTable(
                                  ...
                                  rows: List.generate(paginatedList.length, (
                                    i,
                                  ) {
          ...
          // BAGIAN KANAN
          // ==================================================
          LaporanRiwayatDesktop(ctrl: ctrl),
        ],
      ),
    );
  }
