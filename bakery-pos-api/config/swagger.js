  ...
  definition: {
    ...
    paths: {
      ...
      '/api/stock-adjustment-requests': {
        post: {
          summary: 'Create stock adjustment request',
          ...
          responses: {
            '201': {
              description: 'Stock adjustment request created',
              content: {
                'application/json': {
        ...
        get: {
          summary: 'Get stock adjustment requests by user',
          tags: ['Stock Adjustment'],
          responses: {
            '200': {
              description: 'List of stock adjustment requests',
              content: {
                'application/json': {
                  schema: {
                    type: 'array',
                    items: { $ref: '#/components/schemas/StockAdjustmentRequest' }
                  }
                }
              }
            }
      ...
      '/api/stock-adjustment-requests/all': {
        get: {
          summary: 'Get all stock adjustment requests (Admin)',
          tags: ['Stock Adjustment'],
          parameters: [
          ...
          responses: {
            '200': {
              description: 'List of all stock adjustment requests',
              content: {
                'application/json': {
                  schema: {
                    type: 'array',
      ...
      '/api/stock-adjustment-requests/{id}/approve': {
        put: {
          summary: 'Approve stock adjustment request',
          tags: ['Stock Adjustment'],
          parameters: [
            { name: 'id', in: 'path', required: true, schema: { type: 'integer' } }
          ],
          responses: {
            '200': {
              description: 'Stock adjustment request approved',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/StockAdjustmentRequest' }
                }
      ...
      '/api/stock-adjustment-requests/{id}/reject': {
        put: {
          summary: 'Reject stock adjustment request',
          tags: ['Stock Adjustment'],
          parameters: [
            { name: 'id', in: 'path', required: true, schema: { type: 'integer' } }
          ],
